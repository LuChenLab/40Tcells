...
save(se_Total, file = "/mnt/raid61/Personal_data/tangchao/ScientificData/data/Phenotype/gene/se_Total.RData")
...
save(se_Total, se_PolyA, file = "/mnt/raid61/Personal_data/tangchao/ScientificData/data/Phenotype/gene/se.RData")
