...
RSEM_PolyA <- RSEM_PolyA[intersect(row.names(RSEM_PolyA), row.names(RSEM_Total)), ]
RSEM_Total <- RSEM_Total[intersect(row.names(RSEM_PolyA), row.names(RSEM_Total)), ]

stopifnot(identical(row.names(RSEM_Total), row.names(RSEM_PolyA)))
stopifnot(identical(colnames(RSEM_Total), colnames(RSEM_PolyA)))
...
HTSeq_PolyA <- HTSeq_PolyA[intersect(row.names(HTSeq_PolyA), row.names(HTSeq_Total)), ]
HTSeq_Total <- HTSeq_Total[intersect(row.names(HTSeq_PolyA), row.names(HTSeq_Total)), ]

stopifnot(identical(row.names(HTSeq_Total), row.names(HTSeq_PolyA)))
stopifnot(identical(colnames(HTSeq_Total), colnames(HTSeq_PolyA)))
...
save(RSEM_PolyA_QTL, RSEM_Total_QTL, file = "/mnt/raid61/Personal_data/tangchao/ScientificData/analysis/MatrixEQTL/RSEM_SharedGene_eQTL.RData")
save(HTSeq_PolyA_QTL, HTSeq_Total_QTL, file = "/mnt/raid61/Personal_data/tangchao/ScientificData/analysis/MatrixEQTL/HTSeq_SharedGene_eQTL.RData")
